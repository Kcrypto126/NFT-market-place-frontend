    ...
    <ConnectButton
      ...
      auth={{
        ...
        getLoginPayload: async (params: {
          ...
          return get({
            url: process.env.NEXT_PUBLIC_AUTH_API + 'users/login',
            params: {
        ...
        isLoggedIn: async () => {
          return await get({
            url: process.env.NEXT_PUBLIC_AUTH_API + 'users/isLoggedIn',
          });
        },
        /**
        ...
        doLogout: async () => {
          await post({
            url: process.env.NEXT_PUBLIC_AUTH_API + 'users/logout',
          });
        },
      }}
    />
